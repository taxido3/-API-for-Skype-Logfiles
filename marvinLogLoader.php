...
$marvinConversationData = file_get_contents('JSONdata/marvin.json', 'r');
$marvinConversationDataArray = json_decode($marvinConversationData, true);
...
for($i = count($marvinConversationDataArray)-1; $i >= 0 ; $i--) {
	foreach($marvinConversationDataArray[$i] as $key => $value) {
