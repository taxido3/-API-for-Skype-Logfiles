...
$groupConversationData = file_get_contents('JSONdata/TellerMitte Design.json', 'r');
$groupConversationDataArray = json_decode($groupConversationData, true);
...
for($i = count($groupConversationDataArray)-1; $i >= 0 ; $i--) {
	foreach($groupConversationDataArray[$i] as $key => $value) {
